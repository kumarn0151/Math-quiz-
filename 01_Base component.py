...
# Genarate questions 
    ...
    question1 = input("A rectangle with a side of 4cm and a side of 3cm has an area of ___ cm squared")
    if question1 == "12":
        print("CORRECT ")
    else: 
        question1 = "{}".format
...
question2 = input("A triangle has a base of 3 and a height of 6.  The area is ___ cm squared.")
if question2 == "9":
    print("CORRECT!")
else:
    question2 = "{}".format
    ...
    question3 = input("A Square has sides of 5. The area is ___ cm squared")
    if question3 == "25":
        print("CORRECT!")
    else:
        question3 = "{}".format
